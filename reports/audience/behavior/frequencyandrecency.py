...
def process():
    ...
    report.name = "BehaviorFrequencyAndRecency"
    report.dimensions = ["ga:date", "ga:segment", "ga:sessionCount", "ga:daysSinceLastSession", "ga:pagePath"]
    report.segments = ["gaid::-1", "gaid::-2", "gaid::-3", "sessions::condition::ga:country==United States"]
    report.metrics = ["ga:sessions", "ga:pageViews"]
