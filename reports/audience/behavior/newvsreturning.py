...
def process():
    ...
    report.name = "BehaviorNewVsReturning"
    report.dimensions = ["ga:date", "ga:segment", "ga:userType", "ga:pagePath"]
    report.segments = ["gaid::-1", "gaid::-2", "gaid::-3", "sessions::condition::ga:country==United States"]
    report.metrics = ["ga:users", "ga:newUsers", "ga:sessions", "ga:pageViews", "ga:uniquePageviews", "ga:bounceRate",
