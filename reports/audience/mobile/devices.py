...
def process():
    ...
    report.name = "MobileDevices"
    report.dimensions = ["ga:date", "ga:segment", "ga:mobileDeviceInfo", "ga:mobileDeviceBranding",
                         "ga:mobileDeviceModel", "ga:mobileInputSelector", "ga:operatingSystem",
                         "ga:screenResolution", "ga:pagePath"]
    report.segments = ["gaid::-1", "gaid::-2", "gaid::-3", "sessions::condition::ga:country==United States"]
    report.metrics = ["ga:users", "ga:newUsers", "ga:sessions", "ga:bounceRate", "ga:pageViews",
