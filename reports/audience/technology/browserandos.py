...
def process():
    ...
    report.name = "TechnologyBrowserAndOs"
    report.dimensions = ["ga:date", "ga:segment", "ga:browser", "ga:browserVersion", "ga:pagePath"]
    ...
    report.metrics = ["ga:users", "ga:newUsers", "ga:sessions", "ga:bounceRate", "ga:pageViewsPerSession",
                      "ga:avgSessionDuration", "ga:goalConversionRateAll", "ga:goalCompletionsAll"]
