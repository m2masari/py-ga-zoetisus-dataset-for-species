...
def process():
    report = Report()
    report.category = "Goal11Conversions"
    ...
    report.metrics = ["ga:goal11Starts", "ga:goal11Completions", "ga:goal11Value", "ga:goal11ConversionRate",
                      "ga:goal11Abandons", "ga:goal11AbandonRate"]
