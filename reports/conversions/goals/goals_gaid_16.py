...
def process():
    report = Report()
    report.category = "Goal16Conversions"
    ...
    report.metrics = ["ga:goal16Starts", "ga:goal16Completions", "ga:goal16Value", "ga:goal16ConversionRate",
                      "ga:goal16Abandons", "ga:goal16AbandonRate"]
