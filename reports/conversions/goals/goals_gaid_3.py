...
def process():
    report = Report()
    report.category = "Goal3Conversions"
    ...
    report.metrics = ["ga:goal3Starts", "ga:goal3Completions", "ga:goal3Value", "ga:goal3ConversionRate",
                      "ga:goal3Abandons", "ga:goal3AbandonRate"]
